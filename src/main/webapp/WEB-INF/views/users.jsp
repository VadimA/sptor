...
<tbody>\n");
    ...
    function addUser() {
      ...
      if ($("#work_hour1").val() == "") {
        $("#error1").text("Укажите ssoid");
      }
      else if($("#work_hour2").val() == "") {
        $("#error2").text("Укажите имя");
      }
      else if($("#work_hour3").val() == "") {
        $("#error3").text("Укажите фамилию");
      }
      else if($("#work_hour4").val() == "") {
        $("#error4").text("Укажите пароль");
      }
      else if($("#work_hour5").val() == "") {
        $("#error5").text("Укажите email");
      }
      else {
        var ssoid = $("#work_hour1").val();
        var first_name = $("#work_hour2").val();
        var last_name = $("#work_hour3").val();
        var password = $("#work_hour4").val();
        var email = $("#work_hour5").val();
  ...
  <div class="row" style="background-color:lavender;min-height:850px;">
    ...
    <div class="col-md-8" style="background:beige;min-height:600px; text-align:  center">
      ...
      <div id="new_users"  title="Добавление пользователя"  style="display: none">
        ...
        <table>
          <form:form action="users" commandName="userForm" >
            <tr>
